                    ...
                    <tbody>
                        ...
                        foreach ($result as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger cancelReservationBtn" data-toggle="modal" data-target="#confirmationModal" data-reservation-id="<?php echo $row['id']; ?>">
                                        Cancel Reservation
                                    </button>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                ="modal">Cancel</button>
                <button type="button" class="btn btn-danger" id="confirmCancelBtn" data-toggle="modal" data-target="#success_tic">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Success Modal -->
<div class="modal fade" id="success_tic" tabindex="-1" role="dialog" aria-labelledby="success_tic_Label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="page-body">
